...
function setup(){
  ...
  waistpain = createSprite(windowWidth/3+50,windowHeight/2+100);
  waistpain.addImage(waistPainImg);
  waistpain.visible = false;
  eyepain = createSprite(windowWidth/3+350,windowHeight/2+100);
  eyepain.addImage(eyepainImg);
  eyepain.visible = false;
  legpain = createSprite(windowWidth/3+640,windowHeight/2+100);
...
function pg2(){
  ...
  text("which Problem are You Facing From?",windowWidth/5,windowHeight/6);
   ...
   textSize(30);
   fill("yellow");
   text("EyePain",windowWidth/4+380,windowHeight/2-8);
   legpain.visible = true;
   textSize(30);
   fill("yellow");
   text("LegPain",windowWidth/4+670,windowHeight/2-8);
